...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Key.error'
        db.add_column('core_key', 'error',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True),
                      keep_default=False)

        # Deleting field 'APICache.error'
        db.delete_column('core_apicache', 'error')

    def backwards(self, orm):
        # Deleting field 'Key.error'
        db.delete_column('core_key', 'error')

        # Adding field 'APICache.error'
        db.add_column('core_apicache', 'error',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'core.corporation': {
            ...
            'fixed_value': ('django.db.models.fields.DecimalField', [], {'default': 'None', 'null': 'True', 'max_digits': '25', 'decimal_places': '2', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.key': {
            ...
            'error': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True'}),
